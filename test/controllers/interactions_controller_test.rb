...
class InteractionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create interaction" do
    assert_difference('Interaction.count') do
      post interactions_url, params: { interaction: { batch_id: @interaction.batch_id, flow_id: @interaction.flow_id, interactionType: @interaction.interactionType, task_id: @interaction.task_id, user_id: @interaction.user_id } }
    end
  ...
  test "should update interaction" do
    patch interaction_url(@interaction), params: { interaction: { batch_id: @interaction.batch_id, flow_id: @interaction.flow_id, interactionType: @interaction.interactionType, task_id: @interaction.task_id, user_id: @interaction.user_id } }
