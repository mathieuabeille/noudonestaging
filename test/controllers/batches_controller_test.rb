...
class BatchesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create batch" do
    assert_difference('Batch.count') do
      post batches_url, params: { batch: { flow_id: @batch.flow_id, number: @batch.number, user_id: @batch.user_id } }
    end
  ...
  test "should update batch" do
    patch batch_url(@batch), params: { batch: { flow_id: @batch.flow_id, number: @batch.number, user_id: @batch.user_id } }
