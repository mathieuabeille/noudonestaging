...
class ChecklistsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create checklist" do
    assert_difference('Checklist.count') do
      post checklists_url, params: { checklist: { answer: @checklist.answer, flow_id: @checklist.flow_id, taskline: @checklist.taskline, user_id: @checklist.user_id } }
    end
  ...
  test "should update checklist" do
    patch checklist_url(@checklist), params: { checklist: { answer: @checklist.answer, flow_id: @checklist.flow_id, taskline: @checklist.taskline, user_id: @checklist.user_id } }
